                                  ...
                                  lsm6dsox_odr_xl_t val)
{
  ...
  lsm6dsox_emb_fsm_enable_t fsm_enable = {0};
  lsm6dsox_emb_sens_t emb_sens = {0};
  lsm6dsox_fsm_odr_t fsm_odr = LSM6DSOX_ODR_FSM_12Hz5;
  lsm6dsox_ctrl1_xl_t reg = {0};
  lsm6dsox_mlc_odr_t mlc_odr = LSM6DSOX_ODR_PRGS_12Hz5;
  int32_t ret = 0;
...
{
  lsm6dsox_internal_freq_fine_t reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_func_cfg_access_t reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_page_rw_t page_rw = {0};
  lsm6dsox_page_sel_t page_sel = {0};
  lsm6dsox_page_address_t  page_address = {0};
  uint8_t msb = 0;
  uint8_t lsb = 0;
  int32_t ret = 0;
  uint8_t i = 0;
...
{
  return lsm6dsox_ln_pg_read(ctx, address, val, 1);
}
                            ...
                            uint8_t len)
{
  ...
  for (i = 0; i < len; i++)
  {
    ...
    ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PAGE_VALUE, &buf[i], 1);
    if (ret != 0)
    {
      goto exit;
    }
...
{
  lsm6dsox_counter_bdr_reg1_t reg = {0};
  int32_t ret = 0;
...
/**
  * @brief  Enable the full control of OIS configurations from the Auxiliary / Main SPI. [set]
  *
  * @param  ctx      read / write interface definitions
...
{
  lsm6dsox_func_cfg_access_t func_cfg_access = {0};
  lsm6dsox_ui_int_ois_t ui_int_ois = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    func_cfg_access.ois_ctrl_from_ui = (((uint8_t)val & 0x02U) >> 1u);
...
/**
  * @brief  Enable the full control of OIS configurations from the Auxiliary / Main SPI. [get]
  *
  * @param  ctx      read / write interface definitions
  * @param  val      OIS_CTRL_FROM_OIS, OIS_CTRL_FROM_UI,
  * @retval          interface status (MANDATORY: return 0 -> no Error)
...
/**
* @brief  The SPI2_STATUS_REG_OIS register is read by the auxiliary SPI.[get]
*
* @param  ctx      read / write interface definitions
* @param  val      Get registers SPI2_STATUS_REG_OIS
* @retval          interface status (MANDATORY: return 0 -> no Error)
*
*/
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      Get the values of xlda in reg SPI2_STATUS_REG_OIS
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
int32_t lsm6dsox_aux_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                            uint8_t *val)
{
  lsm6dsox_spi2_status_reg_ois_t reg = {0};
  int32_t ret = 0;
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      Get the values of gda in reg SPI2_STATUS_REG_OIS
  * @retval             interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      Get the values of gyro_settling in reg SPI2_STATUS_REG_OIS
  * @retval             interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
{
  lsm6dsox_ui_ctrl1_ois_t ctrl1_ois = {0};
  lsm6dsox_ui_int_ois_t int_ois = {0};
  int32_t ret = {0};
...
{
  lsm6dsox_i3c_bus_avb_t i3c_bus_avb = {0};
  lsm6dsox_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_i3c_bus_avb_t reg = {0};
  int32_t ret = 0;

  ret = lsm6dsox_read_reg(ctx, LSM6DSOX_I3C_BUS_AVB, (uint8_t *)&reg, 1);

  if (ret == 0)
  {
    reg.pd_dis_int1 = (uint8_t)val;
    ret = lsm6dsox_write_reg(ctx, LSM6DSOX_I3C_BUS_AVB, (uint8_t *)&reg, 1);
  }
                               ...
                               lsm6dsox_int1_pd_en_t *val)
{
  ...
  {
    case 0x00:
      *val = LSM6DSOX_PULL_DOWN_DISC;
      break;

    case 0x01:
      *val = LSM6DSOX_PULL_DOWN_CONNECT;
      break;
...
int32_t lsm6dsox_int_notification_set(const stmdev_ctx_t *ctx,
                                      lsm6dsox_lir_t val)
{
  lsm6dsox_tap_cfg0_t tap_cfg0 = {0};
  lsm6dsox_page_rw_t page_rw = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_wake_up_dur_t wake_up_dur = {0};
  lsm6dsox_free_fall_t free_fall = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_fifo_ctrl1_t fifo_ctrl1 = {0};
  lsm6dsox_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = 0;
...
int32_t lsm6dsox_compression_algo_init_set(const stmdev_ctx_t *ctx,
                                           uint8_t val)
{
  lsm6dsox_emb_func_init_b_t reg = {0};
  int32_t ret = 0;
...
int32_t lsm6dsox_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                             uint16_t val)
{
  lsm6dsox_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  lsm6dsox_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = 0;
...
{
  uint8_t reg[2] = {0};
  lsm6dsox_fifo_status1_t fifo_status1 = {0};
  lsm6dsox_fifo_status2_t fifo_status2 = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_fifo_data_out_tag_t reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_emb_func_fifo_cfg_t reg = {0};
  int32_t ret = 0;
...
int32_t lsm6dsox_sh_batch_slave_set(const stmdev_ctx_t *ctx, uint8_t idx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SLV0_CONFIG + (3U * idx), (uint8_t *)&reg, 1);
  }

  if (ret == 0)
  {
    reg.batch_ext_sens_0_en = val;
    ret = lsm6dsox_write_reg(ctx, LSM6DSOX_SLV0_CONFIG + (3U * idx), (uint8_t *)&reg, 1);
  }
...
{
  lsm6dsox_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_emb_func_status_t reg = {0};
  int32_t ret = 0;
...
int32_t lsm6dsox_mag_offset_set(const stmdev_ctx_t *ctx, const int16_t *val)
{
  ...
  return lsm6dsox_ln_pg_write(ctx, LSM6DSOX_MAG_OFFX_L, &buff[0], 6);
}
...
int32_t lsm6dsox_mag_offset_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = lsm6dsox_ln_pg_read(ctx, LSM6DSOX_MAG_OFFX_L, &buff[0], 6);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t lsm6dsox_mag_soft_iron_set(const stmdev_ctx_t *ctx, const int16_t *val)
{
  ...
  return lsm6dsox_ln_pg_write(ctx, LSM6DSOX_MAG_SI_XX_L, &buff[0], 12);
}
...
int32_t lsm6dsox_mag_soft_iron_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = lsm6dsox_ln_pg_read(ctx, LSM6DSOX_MAG_SI_XX_L, &buff[0], 12);
  if (ret != 0)
  {
    return ret;
  }
...
{
  lsm6dsox_fsm_long_counter_clear_t reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_emb_func_odr_cfg_b_t reg = {0};
  int32_t ret = 0;
                                        ...
                                        uint16_t val)
{
  ...
  ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_L, &buff[0]);
  ret += lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_H, &buff[1]);
                                        ...
                                        uint16_t *val)
{
  ...
  ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_L, &buff[0]);
  ret += lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_H, &buff[1]);
...
int32_t lsm6dsox_fsm_start_address_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_START_ADD_L, &buff[0]);
  ret += lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_START_ADD_H, &buff[1]);
                                       ...
                                       uint16_t *val)
{
  ...
  ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_START_ADD_L, &buff[0]);
  ret += lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_START_ADD_H, &buff[1]);
  if (ret != 0)
  {
    return ret;
  }
...
/**
  * @defgroup  LSM6DSOX_Machine_Learning_Core
  * @brief     This section groups all the functions that manage the
...
/**
  * @brief  Machine Learning Core ODR configuration.[set]
  *
  * @param  ctx      read / write interface definitions
  * @param  val      change the values of mlc_odr in reg EMB_FUNC_ODR_CFG_C
  * @retval             interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
{
  int32_t ret = 0;
  lsm6dsox_emb_func_odr_cfg_c_t emb_func_odr_cfg_c = {0};

  ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);

  if (ret == 0)
  {
    ret = lsm6dsox_read_reg(ctx, LSM6DSOX_EMB_FUNC_ODR_CFG_C, (uint8_t *)&emb_func_odr_cfg_c, 1);

    if (ret == 0)
    {
      emb_func_odr_cfg_c.mlc_odr = (uint8_t)val;
      ret = lsm6dsox_write_reg(ctx, LSM6DSOX_EMB_FUNC_ODR_CFG_C, (uint8_t *)&emb_func_odr_cfg_c, 1);
    }
  }
...
/**
  * @brief  Machine Learning Core ODR configuration.[get]
  *
  * @param  ctx      read / write interface definitions
  * @param  val      Get the values of mlc_odr in reg EMB_FUNC_ODR_CFG_C
  * @retval             interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
{
  lsm6dsox_master_config_t reg = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_slv0_add_t slv0_add = {0};
  lsm6dsox_slv0_config_t slv0_config = {0};
  int32_t ret = 0;
  ...
  slv0_add.rw_0 = 1;
  ret = lsm6dsox_write_reg(ctx, LSM6DSOX_SLV0_ADD + (3U * idx), (uint8_t *)&slv0_add, 1);
  if (ret != 0)
  {
    goto exit;
  }

  ret = lsm6dsox_write_reg(ctx, LSM6DSOX_SLV0_SUBADD + (3U * idx), &(val->slv_subadd), 1);
  if (ret != 0)
  {
    goto exit;
  }

  ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SLV0_CONFIG + (3U * idx), (uint8_t *)&slv0_config, 1);
  if (ret != 0)
  {
    goto exit;
  }
  slv0_config.slave0_numop = val->slv_len;
  ret = lsm6dsox_write_reg(ctx, LSM6DSOX_SLV0_CONFIG + (3U * idx), (uint8_t *)&slv0_config, 1);
                               ...
                               const lsm6dsox_status_master_t *val)
{
  ...
  ret = lsm6dsox_read_reg(ctx, LSM6DSOX_STATUS_MASTER_MAINPAGE, (uint8_t *) val, 1);
...
{
  lsm6dsox_s4s_tph_l_t s4s_tph_l = {0};
  lsm6dsox_s4s_tph_h_t s4s_tph_h = {0};
  int32_t ret = {0};
...
{
  lsm6dsox_s4s_st_cmd_code_t reg = {0};
  int32_t ret = {0};
                        ...
                        lsm6dsox_id_t *val)
{
  ...
  if (aux_ctx != NULL)
  {
    ret += lsm6dsox_read_reg(aux_ctx, LSM6DSOX_WHO_AM_I, (uint8_t *) & (val->aux), 1);
  }
...
{
  lsm6dsox_emb_func_init_a_t emb_func_init_a = {0};
  lsm6dsox_emb_func_init_b_t emb_func_init_b = {0};
  lsm6dsox_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = 0;
                              ...
                              lsm6dsox_bus_mode_t *val)
{
  ...
  if (aux_ctx != NULL)
  {
    ...
    if (ret == 0)
    {
      ...
      {
        case (uint8_t)LSM6DSOX_SPI_4W_AUX:
          val->aux_bus_md = LSM6DSOX_SPI_4W_AUX;
          break;

        case (uint8_t)LSM6DSOX_SPI_3W_AUX:
...
/**
  ...
  *
  */
int32_t lsm6dsox_status_get(const stmdev_ctx_t *ctx,
                            const stmdev_ctx_t *aux_ctx,
                            lsm6dsox_status_t *val)
{
  lsm6dsox_spi2_status_reg_ois_t spi2_status_reg_ois = {0};
  lsm6dsox_ui_status_reg_ois_t   ui_status_reg_ois = {0};
  lsm6dsox_status_reg_t          status_reg = {0};
  lsm6dsox_ctrl3_c_t             ctrl3_c = {0};
  int32_t                       ret = 0;
...
{
  lsm6dsox_i3c_bus_avb_t i3c_bus_avb = {0};
  lsm6dsox_pin_ctrl_t pin_ctrl = {0};
  lsm6dsox_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = 0;
...
{
  lsm6dsox_pin_int2_route_t  pin_int2_route = {0};
  ...
  lsm6dsox_int2_ctrl_t       int2_ctrl      = {0};
  lsm6dsox_mlc_int1_t        mlc_int1       = {0};
  lsm6dsox_tap_cfg2_t        tap_cfg2       = {0};
  lsm6dsox_md2_cfg_t         md2_cfg        = {0};
...
{
  lsm6dsox_pin_int1_route_t pin_int1_route = {0};
  lsm6dsox_emb_func_int2_t  emb_func_int2  = {0};
  lsm6dsox_fsm_int2_a_t     fsm_int2_a     = {0};
  lsm6dsox_fsm_int2_b_t     fsm_int2_b     = {0};
  lsm6dsox_int2_ctrl_t      int2_ctrl      = {0};
  lsm6dsox_tap_cfg2_t       tap_cfg2       = {0};
  lsm6dsox_md2_cfg_t        md2_cfg        = {0};
  lsm6dsox_ctrl4_c_t        ctrl4_c        = {0};
  lsm6dsox_spi2_int_ois_t   spi2_int_ois   = {0};
  lsm6dsox_mlc_int2_t       mlc_int2       = {0};
  int32_t                  ret            = {0};
...
{
  lsm6dsox_emb_func_status_mainpage_t emb_func_status_mainpage = {0};
  lsm6dsox_status_master_mainpage_t   status_master_mainpage   = {0};
  lsm6dsox_fsm_status_a_mainpage_t    fsm_status_a_mainpage    = {0};
  lsm6dsox_fsm_status_b_mainpage_t    fsm_status_b_mainpage    = {0};
  lsm6dsox_mlc_status_mainpage_t      mlc_status_mainpage      = {0};
  lsm6dsox_fifo_status1_t             fifo_status1             = {0};
  lsm6dsox_fifo_status2_t             fifo_status2             = {0};
  lsm6dsox_all_int_src_t              all_int_src              = {0};
  lsm6dsox_wake_up_src_t              wake_up_src              = {0};
  lsm6dsox_status_reg_t               status_reg               = {0};
  lsm6dsox_tap_src_t                  tap_src                  = {0};
  lsm6dsox_d6d_src_t                  d6d_src                  = {0};
  lsm6dsox_ctrl5_c_t                  ctrl5_c                  = {0};
  uint8_t                            reg[12]                  = {0};
  int32_t                            ret                      = {0};
...
/**
  ...
  *
  */
int32_t lsm6dsox_mode_set(const stmdev_ctx_t *ctx, const stmdev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val)
{
  lsm6dsox_func_cfg_access_t func_cfg_access = {0};
  lsm6dsox_spi2_ctrl1_ois_t spi2_ctrl1_ois = {0};
  ...
  ctrl7_g.ois_on_en = (uint8_t)val->ois.ctrl_md & 0x01U;
  func_cfg_access.ois_ctrl_from_ui = (((uint8_t)val->ois.ctrl_md & 0x02U) >> 1) & 0x01U;
...
/**
  ...
  *
  */
int32_t lsm6dsox_mode_get(const stmdev_ctx_t *ctx, const stmdev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val)
{
  lsm6dsox_emb_func_odr_cfg_b_t emb_func_odr_cfg_b = {0};
  lsm6dsox_emb_func_odr_cfg_c_t emb_func_odr_cfg_c = {0};
  lsm6dsox_func_cfg_access_t func_cfg_access = {0};
  lsm6dsox_spi2_ctrl1_ois_t spi2_ctrl1_ois = {0};
  lsm6dsox_spi2_ctrl2_ois_t spi2_ctrl2_ois = {0};
  ...
  lsm6dsox_ui_ctrl2_ois_t ui_ctrl2_ois = {0};
  lsm6dsox_ui_ctrl3_ois_t ui_ctrl3_ois = {0};
  lsm6dsox_emb_func_en_b_t emb_func_en_b = {0};
  lsm6dsox_fsm_enable_a_t fsm_enable_a = {0};
  lsm6dsox_fsm_enable_b_t fsm_enable_b = {0};
  lsm6dsox_ctrl1_xl_t ctrl1_xl = {0};
  lsm6dsox_ctrl2_g_t ctrl2_g = {0};
  lsm6dsox_ctrl3_c_t ctrl3_c = {0};
  lsm6dsox_ctrl4_c_t ctrl4_c = {0};
  ...
  switch ((func_cfg_access.ois_ctrl_from_ui << 1) +
          ctrl7_g.ois_on_en)
  {
    case (uint8_t)LSM6DSOX_OIS_ONLY_AUX:
    ...
    case (uint8_t)LSM6DSOX_OIS_ONLY_UI:
    ...
    case (uint8_t)LSM6DSOX_OIS_MIXED:
      switch (spi2_ctrl3_ois.fs_xl_ois)
      {
        case 0x00:
          val->ois.xl.fs = LSM6DSOX_XL_OIS_2g;
    ...
    default:
      (void)memset(val, 0, sizeof(lsm6dsox_md_t));
      break;
  }
...
{
  lsm6dsox_emb_func_en_a_t emb_func_en_a = {0};
  lsm6dsox_emb_func_en_b_t emb_func_en_b = {0};
  int32_t ret = 0;
